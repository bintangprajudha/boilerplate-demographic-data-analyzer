...
def calculate_demographic_data(print_data=True):
    ...
    rich_percentage = round((len(num_min_workers[num_min_workers['salary'] == '>50K']) / len(num_min_workers)) * 100, 1) if len(num_min_workers) > 0 else 0
    ...
    country_salary = country_salary['>50K'] * 100  # Convert to percentage
